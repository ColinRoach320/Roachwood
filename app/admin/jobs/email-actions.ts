...
/**
 * Job-complete + review-request email. No attachment — this is a
 * plain text message with whatever Colin's pre-filled template
 * contains (Google review link, thank-you copy, etc).
 */
export async function sendJobCompleteEmail(
  ...
  return ok(`Email sent to ${input.to}.`);
}
