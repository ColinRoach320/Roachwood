...
const base =
  "inline-flex items-center justify-center gap-2 rounded-md font-medium tracking-wide transition focus:outline-none focus:ring-2 focus:ring-gold-500/40 disabled:opacity-50 disabled:pointer-events-none";
